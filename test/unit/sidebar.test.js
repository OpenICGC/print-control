...
test("Sidebar", (t) => {
	...
	t.test("#render", (t) => {
		...
		tSidebar.show();
		t.equal(tSidebar.render(), "<div class=\"wrapper  sidebar-left\"><nav id=\"sidebar\" class=\"active\"><!-- Sidebar Header --><div class=\"sidebar-header\"><span class=\"title\">Barra lateral</span></div><div class=\"sidebar-body\"></div></nav></div><div id=\"content\" class=\"sidebar-left\"><button type=\"button\" id=\"sidebarCollapse\" class=\"btn btn-info navbar-btn\">></button><div>");
		t.end();
